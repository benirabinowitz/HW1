...
class WeatherForecast:
    ...
    def find_min_and_max_per_day(self) -> Tuple[torch.Tensor]:
        ...
        """
        return torch.aminmax(self.data, dim=1)
    ...
    def find_the_largest_drop(self) -> torch.Tensor:
        ...
        temp_diff = daily_avg[1:] - daily_avg[:-1]
        largest_drop = torch.min(temp_diff)
        return largest_drop
    ...
    def find_the_most_extreme_day(self) -> torch.Tensor:
        ...
        idx = torch.argmax(torch.abs(self.data - daily_avg), dim=1)
